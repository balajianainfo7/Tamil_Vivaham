...
class receiviedProprosalModel {
  ...
  factory receiviedProprosalModel.fromJson(Map<String, dynamic> json) => receiviedProprosalModel(
       id: json['_id'].toString(),
        name: json['requested_by']['customer_obj_id']['personal_details']['first_name'].toString(),
        // name: json['title'].toString(),
        age: json['requested_by']['customer_obj_id']['personal_details']['age'],
