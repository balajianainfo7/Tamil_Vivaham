...
class BasicUpdateController extends BaseController{
  ...
  if(DoshamController.text.isEmpty){
    showSnackBar("Enter Dosham Details", context);
      ...
      print("objecaaat");
      print(BasicUpdateControllerRegisterAPI(context));
      BasicUpdateControllerRegisterAPI(context);
      // registerAPI(context);
  }
  
}

BasicUpdateControllerRegisterAPI(context) async {
  ...
  final params ={ "basic_details":data};
  print("Basic Address API Params: ${params}");
  http.post(
    ...
    print("value");
    print(value);
    print("Basic Address: ${res.toString()}");
    if (res != null) {
